...
try:
    ...
    # xFormers is an optional inference acceleration.  The repository already
    # contains BasicSelfAttention, but imported xformers unconditionally before
    # consulting XFORMERS_DISABLED, making that fallback unreachable.
    LowerTriangularMask = memory_efficient_attention = unbind = None
    XFORMERS_AVAILABLE = False

XFORMERS_DISABLED = (
    os.environ.get("XFORMERS_DISABLED", "false").lower() == "true"
    or not XFORMERS_AVAILABLE
)
